...
## Lo que prevé la ley: los dos tramos del artículo 83 del RGPD

El RGPD establece dos niveles de multa administrativa. En los dos, la sanción se calcula como "la cuantía que sea mayor" entre un importe fijo en euros y un porcentaje de la facturación:

- **Tramo inferior (artículo 83.4):** hasta **10.000.000 €** o el **2%** del volumen de negocio anual mundial total del ejercicio anterior. Recoge incumplimientos de corte más organizativo, como las obligaciones del responsable y del encargado del tratamiento (por ejemplo, el contrato del artículo 28).
- **Tramo superior (artículo 83.5):** hasta **20.000.000 €** o el **4%** del volumen de negocio, la cuantía que sea mayor. Aquí entran las infracciones más graves, como vulnerar los principios básicos del tratamiento o los derechos de las personas.
...
## ¿Pueden multar a un autónomo o a una pyme pequeña?

Sí. La AEPD no actúa solo contra grandes corporaciones. Cualquier responsable de un tratamiento de datos, sea una sociedad, una pyme o un autónomo, puede ser sancionado si incumple.

Ahora bien, el importe se modula. La Agencia valora la gravedad de la infracción, si hubo intención o negligencia, el número de afectados, la reincidencia y el volumen de negocio, entre otros factores. Por eso una sanción a un negocio pequeño no equivale al máximo legal de 10 o 20 millones: se ajusta a su realidad. Lo que no cambia es que la infracción existe igual, y que el coste de defenderse y corregir después suele superar con creces lo que habría costado prevenir.
...
1. **La sanción en sí**, cuyo suelo no es simbólico incluso en negocios pequeños.
...
El orden lógico para una pyme o un autónomo es saber primero dónde estás y después corregir lo que falte, empezando por lo que más se sanciona (brechas, videovigilancia, contratos con proveedores, web).

- Si quieres un diagnóstico completo de tu situación, la [auditoría RGPD](/auditoria-rgpd/) te da el mapa de qué falta y en qué orden atacarlo.
- Si necesitas poner al día toda la operativa de datos, la [adaptación de empresa al RGPD](/adaptacion-empresa-rgpd/) cubre tratamientos, seguridad y contratos con proveedores.
- Si tu punto débil es la web (cookies, formularios, textos legales), la [adaptación web al RGPD](/adaptacion-web-rgpd/) la deja en regla.

Puedes ver todo el catálogo en nuestros [servicios de protección de datos](/servicios-proteccion-de-datos/). Y si quieres una primera foto sin coste de tu punto de partida, solicita la [auditoría gratuita](/auditoria-web-gratuita/): revisamos por dónde conviene empezar antes de que lo haga la AEPD.
